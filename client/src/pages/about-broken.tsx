  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#BCDCEC] via-[#E8F4F8] to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-4 py-12">
        ...
        {/* ERICA BAKER SECTION */}
        <section id="erica" className="bg-gradient-to-b from-orange-400 to-orange-500 py-16 -mx-4 px-4">
          <div className="max-w-6xl mx-auto">
            {/* Header */}
            <div className="text-center mb-12">
              <div className="text-black text-lg font-medium mb-2">ERICA LEE BAKER</div>
              <div className="text-black text-4xl font-bold">YOGA</div>
            </div>

            {/* Main Content Area */}
            <div className="bg-gradient-to-b from-green-100 to-green-200 rounded-2xl p-8 shadow-xl">
              <div className="grid lg:grid-cols-2 gap-12 items-start">
                {/* Erica Image */}
                <div className="text-center lg:text-left">
                  <div className="w-80 h-80 mx-auto lg:mx-0 mb-6 overflow-hidden shadow-lg rounded-2xl">
                    <img 
                      src={ericaYogaPose} 
                      alt="Erica Baker" 
                      className="w-full h-full object-cover"
                ...
                <div className="space-y-6">
                  <div>
                    <div className="flex items-center gap-4 mb-4">
                      <div className="bg-orange-100 px-4 py-2 rounded-lg border-l-4 border-orange-500">
                        <p className="text-sm font-semibold text-orange-900">Experience</p>
                        <p className="text-2xl font-bold text-orange-900">15</p>
                        <p className="text-sm font-semibold text-orange-900">Years</p>
                      </div>
                    ...
                    <div className="text-gray-800">
                      <p className="text-lg font-medium mb-2">Yoga Alliance E-RYT 200 Yoga Instructor with over 3000 hours teaching experience in both large and small group settings.</p>
                    </div>
                  </div>
              ...
              <div className="mt-12 bg-white rounded-xl p-8 shadow-lg">
                <div className="text-center lg:text-right mb-6">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Updated 6/</h3>
                  <h2 className="text-3xl font-bold text-gray-900">Permanent Class</h2>
                </div>
                
                <div className="space-y-4">
                  <p className="text-lg text-gray-800">
                    Take my Saturday 8am or Wednesday 9am class in my Orange, CT home studio: 
                    <a href="mailto:ejelormine@gmail.com" className="text-blue-500 hover:underline ml-1">email</a>
                  </p>
                  ...
                  <p className="text-gray-600">Contact me to join or to make private class arrangements.</p>
                </div>
              </div>
            </div>
          </div>
