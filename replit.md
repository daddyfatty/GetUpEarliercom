...
```
Changelog:
- July 21, 2025: Fixed alcohol calculator title clipping and updated branding to show both "Alcohol Weight Gain Calculator" and "BUZZKILL CALCULATOR" subtitle - resolved text overflow issues by using responsive text sizing and vertical layout; removed "Show Personal Factors" section from alcohol calculator per user request for cleaner interface; maintained all functionality while streamlining user experience
