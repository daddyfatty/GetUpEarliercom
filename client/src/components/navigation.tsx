              ...
              <div className="flex items-center justify-center space-x-3 lg:space-x-4">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 -mt-[1px] pt-[1px] invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-200 z-50">
                    <div className="bg-gradient-to-br from-white via-purple-50 to-violet-100 dark:from-gray-800 dark:to-gray-900 shadow-2xl rounded-lg border-2 border-purple-300 dark:border-gray-700 mt-1 min-w-[620px] overflow-hidden">
                      ...
                      <div className="px-6 py-3 bg-gradient-to-r from-purple-100 via-purple-100 to-violet-100 dark:from-gray-800 dark:to-gray-800/50 border-b border-purple-200/50 dark:border-gray-700">
                        <span className="text-xs font-bold text-purple-700 dark:text-purple-400 uppercase tracking-wider flex items-center">
