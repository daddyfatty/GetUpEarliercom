...
```
Changelog:
- July 16, 2025: Added Hartford Marathon Training Log Entry #3 "Equipmentless Leg Strength Training Day with basic Calisthenics" (July 15, 2025) - appears at top of training log with YouTube video embed about 400 air-squats workout; entry displays without metrics bar since it's strength training rather than running; maintains Hartford Marathon branding and user's authentic content exactly as provided
- July 16, 2025: Completed comprehensive social media sharing implementation across entire website - added MetaTags component to all major pages (Home, About, Services, Blog, Recipes, Workouts) with dynamic Open Graph tags, Twitter Cards, and LinkedIn meta tags; verified functionality through Facebook Open Graph debugger showing proper title, description, and featured image display; Hartford Marathon Training Log 2025 now properly shares on all social platforms
- July 16, 2025: Added comprehensive social media sharing meta tags to blog posts - Hartford Marathon Training Log 2025 now displays featured Hartford Marathon start line image when shared on Facebook, LinkedIn, Twitter; implemented dynamic Open Graph tags, Twitter Cards, and LinkedIn meta tags that automatically update based on blog post content; copied Hartford Marathon image to public folder for proper social sharing access
