        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start min-h-[600px]">
          ...
          <div className="flex flex-col justify-start pt-16 space-y-6">
            {randomPost ? (
              <div>
                ...
                <Link href={`/blog/${randomPost.slug}`}>
                  <div className="cursor-pointer hover:scale-105 transition-transform duration-300 relative">
                    <div className="w-full h-[32rem] overflow-hidden rounded-2xl shadow-2xl">
                      <img 
              ...
              <div className="rounded-2xl shadow-2xl w-full h-[32rem] bg-gradient-to-br from-purple-500/20 to-blue-500/20 flex items-center justify-center">
