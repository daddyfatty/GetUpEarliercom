...
import { Mail, Phone, Calendar, Clock, MapPin, Star } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <Card className="h-full">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl">Michael Baker</CardTitle>
            ...
            <Card className="h-full">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl">Erica Baker</CardTitle>
                <CardDescription className="text-lg">
