      ...
      <Card className="bg-gradient-to-br from-green-50 via-white to-green-50 dark:from-gray-800 dark:to-gray-900 border-0 shadow-2xl overflow-hidden">
        <CardContent className="p-0">
          <div className="grid lg:grid-cols-5 gap-0">
            ...
            <div className="lg:col-span-2 bg-gradient-to-br from-[#E1ECE7] to-[#C4D6CC] dark:from-green-900 dark:to-gray-900 pt-6 px-8 pb-8 lg:pt-8 lg:px-12 lg:pb-12 text-gray-800 dark:text-white flex flex-col justify-start items-center text-center">
