...
export const servicesData: Service[] = [
  ...
  },
  {
    ...
    title: "Private Yoga",
    description: "Experience the journey of self-discovery, mindfulness, and inner peace in our dedicated yoga studio.",
    color: "blue",
            ...
            {showImages && service.image && (
              <div className="relative overflow-hidden rounded-t-lg">
                <img 
                  src={service.image} 
                  alt={service.title}
                  className="w-full h-[28rem] object-cover group-hover:scale-105 transition-transform duration-300"
                />
