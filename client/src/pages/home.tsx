              ...
              <div className="bg-gradient-to-br from-[hsl(var(--coaching-primary))] via-purple-700 to-[hsl(var(--coaching-accent))] text-white p-6 rounded-2xl shadow-lg h-full flex flex-col">
                ...
                <div className="space-y-3 mt-auto">
                  <Link href="/coaching">
                    <Button 
                      size="md" 
                      className="w-full bg-white text-[hsl(var(--coaching-text))] hover:bg-[hsl(var(--coaching-light))] font-bold px-4 py-2 rounded-full shadow-lg transform hover:scale-105 transition-all duration-200"
                    >
                  ...
                  <Button 
                    size="md" 
                    className="w-full bg-gradient-to-r from-[hsl(var(--coaching-accent))] to-[hsl(var(--coaching-primary))] hover:from-[hsl(var(--coaching-accent))]/90 hover:to-[hsl(var(--coaching-primary))]/90 text-white font-bold px-4 py-2 rounded-full shadow-lg transform hover:scale-105 transition-all duration-200"
