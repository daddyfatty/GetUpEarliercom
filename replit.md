...
```
Changelog:
- July 21, 2025: Fixed Facebook social sharing image and Open Graph properties for alcohol calculator - updated server-side meta tag injection to use correct buzzkill-social.png image instead of buzzkill-calculator-og-image.png; added missing fb:app_id property and proper image dimensions (1200x630) to resolve Facebook sharing debugger warnings; verified social media crawlers now receive proper Open Graph metadata with correct featured image
