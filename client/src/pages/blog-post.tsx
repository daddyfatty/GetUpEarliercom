    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <article className="max-w-4xl mx-auto">
          ...
          {/* Real Food Gallery Section - Only for detox cleanse post */}
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div 
                    className="aspect-square rounded-lg overflow-hidden cursor-pointer hover:shadow-xl transition-shadow group relative bg-gray-100 dark:bg-gray-700"
                    onClick={() => {
                      setLightboxImage("/attached_assets/real-food-fruits.jpg");
                      setLightboxOpen(true);
                    }}
                  >
                    <img
                      src="/attached_assets/real-food-fruits.jpg"
                      alt="Fresh fruits - apples, bananas, berries"
                      className="w-full h-full object-cover"
                      onError={(e) => {
                        e.currentTarget.src = "https://images.unsplash.com/photo-1610832958506-aa56368176cf?w=400&h=400&fit=crop";
                      }}
                    />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3">
                      <p className="text-white text-sm font-semibold">Fresh Fruits</p>
                    </div>
                  </div>
                  ...
                  <div 
                    className="aspect-square rounded-lg overflow-hidden cursor-pointer hover:shadow-xl transition-shadow group relative bg-gray-100 dark:bg-gray-700"
                    onClick={() => {
                      setLightboxImage("/attached_assets/real-food-vegetables.jpg");
                      setLightboxOpen(true);
                    }}
                  >
                    <img
                      src="/attached_assets/real-food-vegetables.jpg"
                      alt="Fresh vegetables - broccoli, carrots, peppers"
                      className="w-full h-full object-cover"
                      onError={(e) => {
                    ...
                    />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3">
                      <p className="text-white text-sm font-semibold">Fresh Vegetables</p>
                    </div>
                  </div>
                  ...
                  <div 
                    className="aspect-square rounded-lg overflow-hidden cursor-pointer hover:shadow-xl transition-shadow group relative bg-gray-100 dark:bg-gray-700"
                    onClick={() => {
                      setLightboxImage("/attached_assets/real-food-grains.jpg");
                      setLightboxOpen(true);
                    }}
                  >
                    <img
                      src="/attached_assets/real-food-grains.jpg"
                      alt="Whole grains - oats, quinoa, brown rice"
                      className="w-full h-full object-cover"
                      onError={(e) => {
                        e.currentTarget.src = "https://images.unsplash.com/photo-1586201375761-83865001e31c?w=400&h=400&fit=crop";
                      }}
                    />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3">
                      <p className="text-white text-sm font-semibold">Whole Grains</p>
                    </div>
                  </div>
                  ...
                  <div 
                    className="aspect-square rounded-lg overflow-hidden cursor-pointer hover:shadow-xl transition-shadow group relative bg-gray-100 dark:bg-gray-700"
                    onClick={() => {
                      setLightboxImage("/attached_assets/real-food-proteins.jpg");
                      setLightboxOpen(true);
                    }}
                  >
                    <img
                      src="/attached_assets/real-food-proteins.jpg"
                      alt="Lean proteins - chicken, fish, eggs"
                      className="w-full h-full object-cover"
                      onError={(e) => {
                        e.currentTarget.src = "https://images.unsplash.com/photo-1608198093002-ad4e005484ec?w=400&h=400&fit=crop";
                      }}
                    />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3">
                      <p className="text-white text-sm font-semibold">Lean Proteins</p>
                    </div>
                  </div>
                  ...
                  <div 
                    className="aspect-square rounded-lg overflow-hidden cursor-pointer hover:shadow-xl transition-shadow group relative bg-gray-100 dark:bg-gray-700"
                    onClick={() => {
                      setLightboxImage("/attached_assets/real-food-nuts.jpg");
                      setLightboxOpen(true);
                    }}
                  >
                    <img
                      src="/attached_assets/real-food-nuts.jpg"
                      alt="Nuts and seeds - almonds, walnuts, chia seeds"
                      className="w-full h-full object-cover"
                      onError={(e) => {
                        e.currentTarget.src = "https://images.unsplash.com/photo-1599599810694-b5b37304c041?w=400&h=400&fit=crop";
                      }}
                    />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3">
                      <p className="text-white text-sm font-semibold">Nuts & Seeds</p>
                    </div>
                  </div>
                  ...
                  <div 
                    className="aspect-square rounded-lg overflow-hidden cursor-pointer hover:shadow-xl transition-shadow group relative bg-gray-100 dark:bg-gray-700"
                    onClick={() => {
                      setLightboxImage("/attached_assets/real-food-dairy.jpg");
                      setLightboxOpen(true);
                    }}
                  >
                    <img
                      src="/attached_assets/real-food-dairy.jpg"
                      alt="Natural dairy - milk, yogurt, cheese"
                      className="w-full h-full object-cover"
                      onError={(e) => {
                        e.currentTarget.src = "https://images.unsplash.com/photo-1628088062854-d1870b4553da?w=400&h=400&fit=crop";
                      }}
                    />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3">
                      <p className="text-white text-sm font-semibold">Natural Dairy</p>
                    </div>
                  </div>
                  ...
                  <div 
                    className="aspect-square rounded-lg overflow-hidden cursor-pointer hover:shadow-xl transition-shadow group relative bg-gray-100 dark:bg-gray-700"
                    onClick={() => {
                      setLightboxImage("/attached_assets/real-food-herbs.jpg");
                      setLightboxOpen(true);
                    }}
                  >
                    <img
                      src="/attached_assets/real-food-herbs.jpg"
                      alt="Fresh herbs and spices"
                      className="w-full h-full object-cover"
                      onError={(e) => {
                        e.currentTarget.src = "https://images.unsplash.com/photo-1509358271058-acd22cc93898?w=400&h=400&fit=crop";
                      }}
                    />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3">
                      <p className="text-white text-sm font-semibold">Herbs & Spices</p>
                    </div>
                  </div>
                  ...
                  <div 
                    className="aspect-square rounded-lg overflow-hidden cursor-pointer hover:shadow-xl transition-shadow group relative bg-gray-100 dark:bg-gray-700"
                    onClick={() => {
                      setLightboxImage("/attached_assets/real-food-fats.jpg");
                      setLightboxOpen(true);
                    }}
                  >
                    <img
                      src="/attached_assets/real-food-fats.jpg"
                      alt="Healthy fats - avocado, olive oil, butter"
                      className="w-full h-full object-cover"
                      onError={(e) => {
                        e.currentTarget.src = "https://images.unsplash.com/photo-1523049673857-eb18f1d7b578?w=400&h=400&fit=crop";
                      }}
                    />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3">
                      <p className="text-white text-sm font-semibold">Healthy Fats</p>
                    </div>
                  </div>
                </div>
