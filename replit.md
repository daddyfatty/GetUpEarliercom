...
```
Changelog:
- July 21, 2025: Updated alcohol calculator branding from "Buzzkill Calculator" to "Alcohol Weight Gain Calculator" throughout site navigation and page headers - removed "Show Personal Factors" section from alcohol calculator per user request for cleaner interface; maintained all functionality while streamlining user experience
