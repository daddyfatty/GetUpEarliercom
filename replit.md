...
```
Changelog:
- July 22, 2025: Replaced both footer email form and newsletter popup with Klaviyo email collection integration - removed custom React newsletter signup forms from footer and purple gradient newsletter popup component, integrated Klaviyo form class "klaviyo-form-ULBmqZ" in both locations for professional email marketing automation; maintained same visual structure and messaging while enabling advanced email campaign capabilities across all pages
