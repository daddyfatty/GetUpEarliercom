...
```
Changelog:
- July 7, 2025: Implemented random blog post display on homepage - blog section now shows a random blog post with featured image and title only, refreshing on each page load
