...
```
Changelog:
- July 22, 2025: Replaced footer email form with Klaviyo email collection integration - removed custom React newsletter signup form and integrated Klaviyo form class "klaviyo-form-ULBmqZ" for professional email marketing automation; maintained same visual structure and messaging while enabling advanced email campaign capabilities
